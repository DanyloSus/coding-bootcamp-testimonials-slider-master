...
const Changer = () => {
  ...
  return (
    <div className="h-14 w-[112px] bg-white rounded-full relative bottom-7 shadow-lg left-[52px] flex items-center justify-around lg:h-10 lg:w-[80px] lg:left-1/2 lg:transform lg:-translate-x-1/2">
      <div
